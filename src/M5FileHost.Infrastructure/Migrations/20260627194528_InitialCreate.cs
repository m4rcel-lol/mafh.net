        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NsfwAllowed = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetId = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Slug = table.Column<string>(type: "character varying(22)", maxLength: 22, nullable: false),
                    ...
                    IsSecurityScanned = table.Column<bool>(type: "boolean", nullable: false),
                    ProcessingError = table.Column<string>(type: "text", nullable: true),
                    OriginalSize = table.Column<long>(type: "bigint", nullable: false),
                    ProcessedSize = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Files_Visibility_IsHidden_CreatedAt",
                table: "Files",
                columns: new[] { "Visibility", "IsHidden", "CreatedAt" });
